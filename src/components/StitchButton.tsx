...
export const StitchButton: React.FC<StitchButtonProps> = ({
  ...
  const variants = {
    primary: "px-8 py-4 bg-primary text-background-dark shadow-[0_0_15px_rgba(0,240,255,0.2)] hover:shadow-[0_0_25px_rgba(0,240,255,0.4)] hover:bg-primary/95 hover:scale-[1.02]",
